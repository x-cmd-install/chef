...
[![x-cmd/install — chef Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/chef.svg?lang=zh)](https://x-cmd.com/install/chef)
...
合计: **191,107** 行代码（覆盖前 5 种语言、共 **1878** 个文件）。
...
- **Star**: 8,242 · **Fork**: 2,519 · **开放 issue**: 3,792 · **贡献者**: 678

## 累计统计

- **发布数**: 4 · **已合并 PR**: 8253 · **开放 PR**: 91 · **已关闭 issue**: 3470 · **开放 issue**: 322 · **提交数**: 34420
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/chef.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:44:46Z._
